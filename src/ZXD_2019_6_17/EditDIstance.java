...
public class EditDIstance {
    ...
    public static int getStrDistance(String a, String b) {
        ...
        // 实现状态转移方程
        // 请注意由于 Java 语言实现的关系，代码里的状态转移是从
        // d[i, j] 到 d[i+1, j+1]，而不是从 d[i-1, j-1] 到 d[i, j]。本质上是一样的。
        for (int i = 0; i < a.length(); i++) {
            for (int j = 0; j < b.length(); j++) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(EditDIstance.getStrDistance("moussfjdskfsdjfsjksdgsde", "mouuse"));
